...
public class Producto {
	...
	/*
	 * JPA nos permite mediante la anotación @Lob para
	 * mapear con la base de datos objetos pesados, 
	 * como podría ser imágenes, xml, archivos binarios, 
	 * cadenas de texto extensas, ficheros json, etc. 
	 * Cualquier objeto que pueda tener un tamaño muy grande 
	 * o de longitud indefinida.
	 * En este caso quizá no haría falta ponerlo a la descripción 
	 * de un producto pero puede que haya algunas con muchos caracteres
	 * y así vemos la anotación.
	 * */
	...
	//Aunque aparece aquí la anotación, en este ejemplo, 
	//no se gestiona la asociación de Producto y puntuaciones
	//se deja para vosotros
